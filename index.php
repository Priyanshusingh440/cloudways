...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <input type="radio" name="user_type" value="1" style="margin-right:1%;">
   <label for="employee">Admin</label>

  <input type="radio" name="user_type" value="2" style="margin-left:0.5%;margin-right:1%;">Employee
